    ...
    ros::Publisher go_to = node.advertise<std_msgs::String>("/control_baxter/ros_cmd_bridge", 1000);
        ...
        while (ros::ok()){
            ...
            if (case3) {
                ...
                cmdStr_l << "1.011 -0.059 -2.989 " << pos_mark10.position.x << " " << (pos_mark10.position.y+0.08) << " " << (pos_mark10.position.z-0.037);
                    // cmdStr_l.str();
                std_msgs::String cmdstring;
                cmdstring.data = cmdStr_l.str();
                go_to.publish(cmdstring);
            ...
            if (case5) {
                ...
                nine_y = pos_mark9.position.y;
                nine_z = pos_mark9.position.z;
                cmdStr_l << "1.011 -0.059 -2.989 " << pos_mark10.position.x << " " << (pos_mark10.position.y+0.1) << " " << (pos_mark10.position.z-0.37);
                    // cmdStr_l.str();
                std_msgs::String cmdstring;
                cmdstring.data = cmdStr_l.str();
                go_to.publish(cmdstring);
